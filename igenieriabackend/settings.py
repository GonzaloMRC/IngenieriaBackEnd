"""
Django settings for igenieriabackend project.
...
SECRET_KEY = 'django-insecure-jk7ljhfjx*ydbdnnqm&!nbh(_@n%cod5wkm-r3(0a+7povxppk'
...
WSGI_APPLICATION = 'igenieriabackend.wsgi.application'
